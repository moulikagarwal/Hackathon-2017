...
function MasterCtrl(t,e,o){var g=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(o,l){o>=g?angular.isDefined(e.get("toggle"))?t.toggle=!!e.get("toggle"):t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){var o=require("fs"),g=o.readFileSync("../a.txt").toString("utf-8");console.log(g);var l=new Audio("http://localhost:4007/api/synthesize?voice=en-US_MichaelVoice&text=");l.play(),t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore",MasterCtrl]);
